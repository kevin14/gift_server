...
<div class="extract-wrapper">
    <div class="extract-box">
        <div class="content">
            <span class="title">输入提取码</span>

            <form action="./extract" method="POST">
                <input type="text" class="code" name="fetchCode" placeholder="请输入您拿到的提取码">
                ...
                <p class="desc">
                    ...
                    一个包含六个不同礼品的礼包<br>
                    当您提取礼包成功后<br>
                    可以从六个礼品中挑选您最喜欢的那个<br>
                    作为您的礼品
                </p>
                <!-- <a href="#" class="get">立即提取</a> -->
                <button type="submit" class="get">立即提取</button>
            </form>
            <img src="/img/extract_gift.jpg" alt="" class="gift-img"/>
        </div>
    </div>
</div>
<div class="footer">
