 ...
 */
@Entity
@Table(name = "gbtb_product_tag", schema = "", catalog = "giftbox")
public class GbtbProductTagEntity {
    private int id;
    ...
    @Basic
    @Column(name = "tag_id", nullable = true, insertable = true, updatable = true)
    ...
    public boolean equals(Object o) {
        ...
        GbtbProductTagEntity that = (GbtbProductTagEntity) o;
